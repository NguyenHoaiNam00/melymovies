    ...
    public function postRecoverNewPassword(Request $request, $token)
    {
        ...
        if ($result) {
            if ($request->password == $request->repassword) {
                ...
                $user->save();
                return redirect()->route('user.index')->with(['thongbao_level' => 'success', 'thongbao' => "<b>Khôi phục mật khẩu thành công!</b><br>Hãy tận hưởng những phút giây thư giản trên <b>MelyMovies</b>"]);
            } else
